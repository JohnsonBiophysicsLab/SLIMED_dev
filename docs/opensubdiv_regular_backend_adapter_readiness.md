...
`docs/opensubdiv_regular_route_performance.md`; the proposed cache ownership,
fingerprint, invalidation, and concurrency gates are recorded in
`docs/opensubdiv_regular_cache_readiness.md`.
