...
- `diagnose_opensubdiv_regular_production_call_parity` can be called only as a
  ...
  direct/routed values at that residual, so it is readiness evidence for the
  next decision, not approval to activate routing.
