...
OBJECT_SCHEMAS.update({
    ...
    "d12_platform": closed({
        "platform_state": PLATFORM_STATE, "expected_fingerprint": {"type": "object"},
        "observed_fingerprint": {"type": "object"},
        "field_mismatches": array(NONEMPTY_STRING),
        "compiler_identity": NONEMPTY_STRING, "github_hosted": {"type": "boolean"},
        "virtualization_observation": {"type": "object"},
        "power_thermal_observations": array({"type": "object"}),
    }),
    "d12_workload": closed({
