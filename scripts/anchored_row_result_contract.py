    ...
    "d12_platform": closed({
        ...
        "power_thermal_observations": array(closed({
            ...
            "probe": closed({
                ...
                "kind": {"const": "bfr_platform_probe"},
                "status": {"enum": ["ok", "query_failed"]},
                "finite": {"const": True},
                "fingerprint_queries_ok": {"type": "boolean"},
                "fingerprint": {"oneOf": [
                    {"const": {}},
                    closed({
                        "architecture": NONEMPTY_STRING,
                        "chip": NONEMPTY_STRING,
                        "hw_logicalcpu": UINT64,
                        "hw_memsize_bytes": UINT64,
                        "hw_model": NONEMPTY_STRING, "hw_ncpu": UINT64,
                        "hw_perflevel0_logicalcpu": UINT64,
                        "hw_perflevel0_physicalcpu": UINT64,
                        "hw_perflevel1_logicalcpu": UINT64,
                        "hw_perflevel1_physicalcpu": UINT64,
                        "hw_physicalcpu": UINT64,
                        "kern_hv_vmm_present": UINT64,
                        "macos_build": NONEMPTY_STRING,
                        "macos_version": NONEMPTY_STRING,
                    })]},
                "power": closed({
                    "api": NONEMPTY_STRING, "query_ok": {"type": "boolean"},
                    "raw": {"type": "string"}, "value": {"type": "string"},
                }),
                "thermal": closed({
                    "api": NONEMPTY_STRING, "query_ok": {"type": "boolean"},
                    "raw": SIGNED_INTEGER, "value": {"type": "string"},
                }),
                "process_returncode": {"type": ["integer", "null"]},
            }),
        })),
    }),
    "d12_workload": closed({
...
CRITERION_ROWS = (
    ...
    ("exact_effective_d10_coeff", 1188000,
     ...
     ("absolute_rational_target_v1",), ("PASS", "FAIL", "UNCOVERED"),
     ("D10_COEFFICIENT_TARGET_EXCEEDED", "CANDIDATE_NONFINITE") +
     D10_ORACLE_REASONS, "l1"),
...
def expand_mutation_manifest(schema_paths):
    ...
    fixed = {
        "M17": ("gap", "overlap", "outside-request",
                 ...
                 "uniform-as-primary", "propagation-gap",
                 "propagation-extra", "propagation-wrong-reason",
                 "propagation-axis-gap"),
