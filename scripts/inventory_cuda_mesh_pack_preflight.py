...
ANCHORS: tuple[Anchor, ...] = (
    ...
    Anchor("test", Path("tests/test_cuda_mesh_pack.cpp"), "FaceLocalPermutationIsPreservedInCanonicalOccurrences"),
    Anchor("test", Path("tests/test_cuda_mesh_pack.cpp"), "RejectsVertexAndFaceStorageIdentityDriftAtomically"),
