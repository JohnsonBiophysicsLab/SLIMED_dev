...
ANCHORS: tuple[Anchor, ...] = (
    ...
    Anchor(
        "documented gap",
        "serial/OpenMP tolerance policy gap",
        FIXTURE_DOC_PATH,
        "tolerance and baseline policy beyond the synthetic 11-control fixture",
        "remaining evidence gap",
        "Representative serial/OpenMP irregular force tolerances are not yet established.",
    ),
    Anchor(
        "documented gap",
        "broader extraordinary-valence gap",
        FIXTURE_DOC_PATH,
        "broader extraordinary-valence support",
        "remaining evidence gap",
    ...
    Anchor(
        "documented gap",
        "representative fixture discovery gap",
        FIXTURE_DOC_PATH,
        "stable way to discover an interior 11-control face",
        "remaining evidence gap",
        "Physical fixture discovery remains separate from the synthetic 11-control characterization.",
    ),
    Anchor(
        "dependency boundary",
...
ROUTE_MATRIX: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "evidence": "synthetic child-regular-force transpose test",
        "remaining_gap": "representative fixtures and serial/OpenMP tolerance policy",
    },
    {
        "route": "11-control membrane force with Param::subDivideTimes <= 0",
