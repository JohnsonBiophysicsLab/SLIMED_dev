...
ANCHORS = {
    ...
    DOC: (
        ...
        "scope-aware cross-platform",
        "global energy: `3e-5`",
        "per-face energy: `2e-6`",
        "per-face geometry: `3e-7`",
        "digest remains reporting-only",
        "beyond any scope's envelope",
        "require whitespace followed by true EOF",
    ),
    READINESS: (
        ...
        "scope-aware cross-platform absolute envelope",
        "rounded digest is",
        "reporting-only and cannot clear either gate",
    ...
    TEST: (
        ...
        "test_cross_platform_envelope_is_scope_bounded",
