...
EVIDENCE_MATRIX: tuple[dict[str, str], ...] = (
    ...
    {
        "claim": "regular OpenSubdiv adapter proof",
        "current_status": "opt-in test-only adapter proof",
...
ANCHORS: tuple[Anchor, ...] = (
    ...
    Anchor(
        "evidence map",
        "regular adapter proof",
        EVIDENCE_DOC_PATH,
        "kind: test_only_regular_opensubdiv_adapter_proof",
        "opt-in adapter proof",
        "The map documents the test-only regular adapter proof report.",
    ),
    Anchor(
        "evidence map",
        "regular adapter proof non-production caveat",
        EVIDENCE_DOC_PATH,
    ...
    Anchor(
        ...
        "opt-in OpenSubdiv evidence",
        "The probe can emit test-only regular adapter proof evidence.",
    ),
    Anchor(
        "probe",
