...
ANCHORS = {
    ...
    "coordinate sensitivity": (SOURCE, "coordinateMutationIsObservable"),
    ...
    "face index miss": (SOURCE, "faceIndexMutationMiss"),
    "eligibility miss": (SOURCE, "eligibilityFlagsMutationMiss"),
    "quadrature miss": (SOURCE, "quadratureMutationMiss"),
    "reference rows miss": (SOURCE, "referenceRowsMutationMiss"),
    "serialized mutation readers": (SOURCE, "serializedMutationReadersSeeRebuild"),
    "exact boundary option": (SOURCE, "VTX_BOUNDARY_EDGE_ONLY"),
    ...
    "production helper observable path": (SOURCE, "run_regular_observables"),
    "repeated area force": (SOURCE, "repeatedAreaForceOneBuild"),
    "full observable parity": (SOURCE, "fullObservableParity"),
