...
CPP_PROOF_INVARIANTS: tuple[dict[str, str], ...] = (
    ...
    {"invariant": "proof-local dry runs remain isolated", "needle": '\\"route_installed_in_production\\":false'},
    ...
    {"invariant": "production route policy active state", "needle": "current_policy_satisfied_route_active"},
...
ANCHORS: tuple[Anchor, ...] = (
    ...
    Anchor(
        ...
        "The C++ proof emits the current guarded production-route policy diagnostic.",
    ),
    Anchor(
        "c++ proof",
    ...
    Anchor(
        "c++ proof",
        "production route policy active decision",
        CPP_PROOF_PATH,
        "current_policy_satisfied_route_active",
        "The policy report records that the explicitly gated regular route is active.",
    ),
    Anchor(
        "c++ proof",
