...
REGULAR_READINESS_CRITERIA: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "current_status": "opt-in regular actual-force probe, C++ proof rows, production-helper dry run, guarded helper route test, and diagnostic production-call parity recheck exposing remaining fArea/fVolume deltas, source-id residual locations, row-error budget location, and exact direct-row override control",
